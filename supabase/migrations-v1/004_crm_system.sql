-- =============================================================================
-- V1 CONSOLIDATED MIGRATION: CRM SYSTEM
-- =============================================================================
-- This migration creates the CRM (Customer Relationship Management) tables:
-- - companies: Business organizations
-- - contacts: Individual contacts linked to companies
-- - deal_stages: Kanban board stages for deals
-- - deals: Sales opportunities
-- - tasks: Action items linked to contacts/companies/deals
-- - notes: Notes and activity records
-- - activities: Activity history timeline
-- =============================================================================
...
-- =============================================================================
-- DEAL STAGES TABLE (For Kanban Board)
-- =============================================================================
...
-- COMMENTS
-- =============================================================================
COMMENT ON TABLE companies IS 'Business organizations in the CRM';
COMMENT ON TABLE contacts IS 'Individual contacts linked to companies';
COMMENT ON TABLE deal_stages IS 'Kanban board stages for sales pipeline';
COMMENT ON TABLE deals IS 'Sales opportunities and deals';
COMMENT ON TABLE tasks IS 'Action items and to-dos';
COMMENT ON TABLE notes IS 'Notes and activity records';
COMMENT ON TABLE activities IS 'Activity history timeline for entities';
